...
- All pins of the MCU are brought to the outside in case the programmer doesn't work, and there is need of programming via an external devboard *(like the [ESP32 D1 MINI](Datasheets/esp32_d1_mini_datasheet.pdf)*
### Card H-bridge
...
- The remote
- The programmer
Footprints that aren't included in KiCads base installation are found on [SnapMagic](https://www.snapeda.com/home/) or made via the footprint editor *(these can be found in [/shema/libraries](../schema/libraries) folder)*.
## Routes
### All routes
...
## Assembly
The assembly was made easier using the [BOM file](Files/ibom.html).
 generated by KiCad.
### Module
...
# Casing
## 3D-printer
The casing is made using OpenSCAD. The files can be found in the *[/3d_casing](../3d_casing)* directory.
Only a casing for the module was made due to time constraints.

[![casing](Images/casing/casing.png)](../3d_casing/0_casing.scad)
...
[![pcb_plate](Images/casing/pcb_plate.png)](../3d_casing/1_pcb.scad)
### Converter plate
The converter plate will hold one step-up and two step-down converters. It will be placed on the second level of the box.

[![converter_plate](Images/casing/converter_plate.png)](../3d_casing/2_converter.scad)
### Box
...
[![box_level_1](Images/casing/box_level_1.png)](../3d_casing/3_box.scad)
[![box_level_2](Images/casing/box_level_2.png)](../3d_casing/3_box.scad)
[![box_level_3](Images/casing/box_level_3.png)](../3d_casing/3_box.scad)
### Sensor
...
[![sensor](Images/casing/sensor.png)](../3d_casing/4_sensor.scad)
### Shooter
...
[![shooter_arm](Images/casing/shooter_arm.png)](../3d_casing/5_shooter_arm.scad)
[![shooter_mount](Images/casing/shooter_mount.png)](../3d_casing/5_shooter_mount.scad)
### Lid
...
[![lid_mount](Images/casing/lid_mount.png)](../3d_casing/6_lid_mount.scad)
...
[![base_plate](Images/lasercut/base_plate.png)](../laser_cutter/plate.scad)
...
## Code
The code was made using the ArduinoIDE. The files can be found in the *[/arduino_sketches](../arduino_sketches)* directory. The used setting to program the ESP32 where as follows:

![arduino_ide_settings](Images/arduino_ide_settings.png)

The code was developed in three stage:
1) Module usage
2) Combinations
3) Final sketch

The first step is to make sure all modules work separately. The modules in question are:
- [Card Motor](../arduino_sketches/1_card_motor/1_card_motor.ino)
- [Servo](../arduino_sketches/1_servo/1_servo.ino)
- [Sensor](../arduino_sketches/1_pot_arm/1_pot_arm.ino)
- [Rotation Motor](../arduino_sketches/1_hori_motor/1_hori_motor.ino)
